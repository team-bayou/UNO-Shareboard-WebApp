              ...
              <div className="uk-width-expand">
                  ...
                  <ul className="ad-owner-contact uk-comment-meta uk-subnav uk-subnav-divider">
                      <li>
                        ...
                        <span className="ad-owner-phone uk-icon-button uk-margin-small-right" data-uk-icon="icon: whatsapp" title={this.props.owner.phoneNumber} data-uk-tooltip="pos: bottom"></span>
